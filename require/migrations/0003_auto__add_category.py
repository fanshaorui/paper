...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'require_category', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=250)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=250)),
        ))
        db.send_create_signal(u'require', ['Category'])

        # Adding M2M table for field category on 'Requirement'
        m2m_table_name = db.shorten_name(u'require_requirement_category')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('requirement', models.ForeignKey(orm[u'require.requirement'], null=False)),
            ('category', models.ForeignKey(orm[u'require.category'], null=False))
        ))
        db.create_unique(m2m_table_name, ['requirement_id', 'category_id'])


    def backwards(self, orm):
        # Deleting model 'Category'
        db.delete_table(u'require_category')

        # Removing M2M table for field category on 'Requirement'
        db.delete_table(db.shorten_name(u'require_requirement_category'))
    ...
    models = {
        ...
        u'require.requirement': {
            ...
            'category': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['require.Category']", 'symmetrical': 'False', 'blank': 'True'}),
