...
class RequirementForm(forms.Form):
	...
	description=forms.CharField(max_length=10000,widget=forms.Textarea(attrs={'placeholder':'请输入论文的需求','cols':30,'rows':8,'class':'editor'}),error_messages=description_error_messages)
