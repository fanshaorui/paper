...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Requirement.theme'
        db.add_column(u'require_requirement', 'theme',
                      self.gf('django.db.models.fields.CharField')(default=111, max_length=140),
                      keep_default=False)

        # Adding field 'Requirement.circle_min'
        db.add_column(u'require_requirement', 'circle_min',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Requirement.circle_max'
        db.add_column(u'require_requirement', 'circle_max',
                      self.gf('django.db.models.fields.IntegerField')(default=4),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Requirement.theme'
        db.delete_column(u'require_requirement', 'theme')

        # Deleting field 'Requirement.circle_min'
        db.delete_column(u'require_requirement', 'circle_min')

        # Deleting field 'Requirement.circle_max'
        db.delete_column(u'require_requirement', 'circle_max')
