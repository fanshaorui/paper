...
class changeProfileForm(forms.Form):
	...
	selfdescription=forms.CharField(max_length=10000,widget=forms.Textarea(attrs={'placeholder':'写作能力介绍','type':'text'}),error_messages=selfdescription_error_messages)
