...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'transaction_transaction', 'order_id',
                      self.gf('django.db.models.fields.DecimalField')(default=datetime.datetime(1999, 1, 1, 0, 0), unique=True, max_digits=32, decimal_places=0),
                      keep_default=False)

        # Adding unique constraint on 'Transaction', fields ['requirement']
        db.create_unique(u'transaction_transaction', ['requirement_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Transaction', fields ['requirement']
        db.delete_unique(u'transaction_transaction', ['requirement_id'])
    ...
    models = {
        ...
        u'transaction.transaction': {
            ...
            'finish': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order_id': ('django.db.models.fields.DecimalField', [], {'unique': 'True', 'max_digits': '32', 'decimal_places': '0'}),
